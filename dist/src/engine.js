...
export class LiaContextEngine {
    ...
    async compact(params) {
        ...
        try {
            const { compactedMessages, tokensBefore, tokensAfter } = await compactMessages(session.messages, this.deps.completeFn, this.config.compactionModel);
    ...
    async afterTurn(params) {
        ...
        const needsCompaction = estimatedTokens >= threshold;
        if (needsCompaction) {
