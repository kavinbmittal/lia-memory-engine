...
- Structured compaction via configurable LLM model (default: claude-haiku-4-5) — summarizes older messages while preserving Q&A structure, with automatic chunking for conversations exceeding model context limits
